...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_GABRIEL_PLUS)
extern struct cpufreq_governor cpufreq_gov_gabriel_plus;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_gabriel_plus)
